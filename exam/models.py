...
class Complaint(models.Model):
    ...
    Session = models.CharField(max_length=10, choices=studymode.choices, default=False)
    ...
    Status = models.CharField(max_length=20, choices=status.choices, default=False)
...
class Results(models.Model):
    ...
    Year = models.CharField(max_length=20, choices=YearOfExam.choices)
    Study_mode = models.CharField(max_length=30, choices=study.choices)
    Semester = models.CharField(max_length=30, choices=list.choices)
